...
from jobs import daily_sync_job, overdue_watch_job, reminder_job
...
async def main() -> None:
    ...
    # app_settings'ni oldindan keshlab olamiz -- reminder_job.schedule_all()
    # shu yerdan reminder_schedule'ni oladi; admin /reminders orqali
    # o'zgartirsa, handler o'sha funksiyani qayta chaqirib job'larni yangilaydi.
